...
{
    public class MixerLevelsGetCommandResponse : AmcpResponse
    {
        public MixerLevels Levels { get; private set; }
        ...
        internal override void ProcessData(AmcpParsedData data)
        {
            ...
            Levels = new MixerLevels(values[0], values[1], values[2], values[3], values[4]);
        }
    }
}